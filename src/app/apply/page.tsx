...
export default async function ApplyPage({
  ...
  const [servicePrices, shippingRules, insuranceRules, autographPricing, profile, addresses] = await Promise.all([
    ...
    prisma.autographPricing.findMany({ where: { isActive: true } }),
    getCustomerProfile(),
    getMyAddresses(),
  ]);
