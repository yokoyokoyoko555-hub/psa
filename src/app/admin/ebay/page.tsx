...
/**
 * 販売（eBay買取）タブの着地点。Phase 2以降、買取契約・出品・注文/精算・発送などの
 * 画面をここに追加していく（docs/EBAY_CONSIGNMENT_SALES_SPEC.md §14.2 / ADR-0087）。
 */
export default function AdminEbayDashboardPage() {
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <h1 className="text-xl font-bold text-gray-900">販売（eBay買取）</h1>
