...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-900 to-brand-700 flex flex-col items-center justify-center text-white px-4">
      <div className="max-w-2xl w-full text-center">
        <h1 className="text-4xl font-bold mb-4">トレカビンクス</h1>
        <p className="text-xl text-brand-200 mb-2">PSA鑑定受付代行サービス</p>
